...
{{ tuple $saName $saNamespace $releaseName $clusterBinding $roleName | include "kubernetes-common.snippets.kubernetes_rbac_binding" }}
{{ tuple $saName $saNamespace $releaseName $clusterBinding $deps $roleName | include "kubernetes-common.snippets.kubernetes_rbac_role" }}
