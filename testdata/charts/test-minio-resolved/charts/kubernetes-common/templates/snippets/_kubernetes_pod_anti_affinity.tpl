...
{{- define "kubernetes-common.snippets.kubernetes_pod_anti_affinity._match_expressions" -}}
{{- $envAll := index . "envAll" -}}
...
podAntiAffinity:
{{- $matchExpressions := include "kubernetes-common.snippets.kubernetes_pod_anti_affinity._match_expressions" ( dict "envAll" $envAll "application" $application "component" $component ) -}}
