...
{{- define "kubernetes-common.snippets.kubernetes_pod_rbac_serviceaccount" -}}
{{- $envAll := index . 0 -}}
{{- $deps := index . 1 -}}
{{- $saName := index . 2 -}}
...
{{- tuple $envAll $resourceList $saName $ns | include "kubernetes-common.snippets.kubernetes_pod_rbac_roles" }}
{{- end -}}
{{- end -}}