...
func (_m *Sessioner) DeleteRelease(m *cluster.DeleteMeta) {
	_m.Called(m)
}

// DeleteReleases provides a mock function with given fields: dm
func (_m *Sessioner) DeleteReleases(dm []*cluster.DeleteMeta) {
	_m.Called(dm)
}
...
func (_m *Sessioner) InstallRelease(_a0 *cluster.ReleaseMeta, _a1 []byte, _a2 bool) (string, string, error) {
